...
const themeDicts: DictionaryResource[] = [
  {
    ...
    category: '自定义主题',
    tags: ['根据主题'],
    url: '/dicts/theme_months.json',
    length: 12,
    language: 'en',
    languageCategory: 'en',
  },
  {
    id: 'theme_foods_all_en_40',
    name: '食物',
    description: '常见食物的英文名称，分章节',
    category: '自定义主题',
    tags: ['根据主题'],
    url: '/dicts/theme_foods_all.json',
    length: 40,
    language: 'en',
    languageCategory: 'en',
  },
  {
    id: 'theme_seasons_en_4',
    name: '季节',
    description: '春夏秋冬的英文名称',
    category: '自定义主题',
    tags: ['根据主题'],
    url: '/dicts/theme_seasons.json',
    length: 5,
    language: 'en',
    languageCategory: 'en',
  },
  {
    id: 'theme_drinks_en',
    name: '饮料',
    description: '常见饮料的英文名称',
    category: '自定义主题',
    tags: ['根据主题'],
    url: '/dicts/theme_drinks.json',
    length: 50,
    language: 'en',
    languageCategory: 'en',
  },
  {
    id: 'theme_currencies',
    name: '货币',
    description: '常见货币的英文及中文名称',
    category: '自定义主题',
    tags: ['根据主题'],
    url: '/dicts/theme_currencies.json',
    length: 10,
    language: 'en',
    languageCategory: 'en',
  },
  {
    id: 'theme_ielts_countries_140',
    name: '雅思国家和地区',
    description: '所有雅思考试国家和地区（含分洲）',
    category: '自定义主题',
    tags: ['根据主题'],
    url: '/dicts/theme_ielts_countries.json',
    length: 140,
    language: 'en',
    languageCategory: 'en',
  },
  {
    id: 'theme_jobs_en_70',
    name: '职业',
    description: '常见职业的英文名称，分章节',
    category: '自定义主题',
    tags: ['根据主题'],
    url: '/dicts/theme_jobs.json',
    length: 70,
    language: 'en',
    languageCategory: 'en',
  },
  {
    id: 'theme_geography_en_11',
    name: '世界地理',
    description: '七大洲和四大洋的英文名称',
    category: '自定义主题',
    tags: ['根据主题'],
    url: '/dicts/theme_geography.json',
    length: 11,
    language: 'en',
    languageCategory: 'en',
  },
  {
    id: 'theme_names_en_35',
    name: '常见人名',
    description: '雅思听力考试中常见的英文人名，分男女',
    category: '自定义主题',
    tags: ['根据主题'],
    url: '/dicts/theme_names.json',
    length: 35,
    language: 'en',
    languageCategory: 'en',
  },
  {
    id: 'theme_countries_cities_en_50',
    name: '常见国家和城市',
    description: '雅思听力考试中常见的国家和城市名称',
    category: '自定义主题',
    tags: ['根据主题'],
    url: '/dicts/theme_countries_cities.json',
    length: 50,
    language: 'en',
    languageCategory: 'en',
  },
  {
    id: 'theme_nationalities_en_35',
    name: '常见国籍',
